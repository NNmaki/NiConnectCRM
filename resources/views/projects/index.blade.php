            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                ...
                <div class="flex items-center justify-between">
                    <div class="flex items-center">
                        <span class="material-symbols-outlined text-yellow-600 text-6xl ml-2">calendar_month</span>
                        <span class="text-gray-900 text-3xl ml-6">Projects</span> 
                    </div>
                     <a href="{{ route('projects.create') }}" class="mt-4 mr-4 inline-flex items-center px-4 py-2 bg-gray-300 border border-transparent rounded-md font-semibold text-xs text-gray-700 uppercase tracking-widest hover:bg-gray-400 focus:bg-gray-400 active:bg-gray-500 focus:outline-none focus:ring-2 focus:ring-gray-500 focus:ring-offset-2 transition ease-in-out duration-150">
                    {{ __('New project') }}</a>
                </div>
                    <table class="min-w-full divide-y divide-gray-200 border mt-4">
                        ...
                        @foreach($projects as $project)
                            <tr class="bg-white hover:bg-sky-50 transition-colors duration-150 cursor-pointer" onclick="window.location='{{ route('projects.edit', $project) }}'">
